  ...
  return (
    <div className='group relative'>
      ...
      <img src={product.image} alt='product image' className=' w-full
       h-full object-cover group-hover:scale-110 duration-500  '/>
       </div>
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='flex justify-end gap-2 relative overflow-hidden w-28 text-sm' >
           <div className='flex gap-2 transform group-hover:translate-x-24 transition-transform
            duration-500'>
           ...
           '>Add To Cart{''}<span><BsArrowRight size={32} className='pb-5 font-bold' /></span></p>
        </div>
         </div>
          <div>
          ...
          <div className='absolute top-4 right-0 '>
              {
                product.isNew && (<p className='bg-black text-white font-semibold px-6 py-1'>Sale</p>) 
              }
          </div>
      </div>
    </div>
